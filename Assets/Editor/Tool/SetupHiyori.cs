...
{
    public class Live2DCubism3CVVTuberExampleMenuItem_Hiyori : MonoBehaviour
    {
    
        [MenuItem ("Tools/CVVTuberExample/Setup Live2DCubism3CVVTuberExample_Hiyori", false, 1)]
        public static void SetLive2DCubism3CVVTuberSettings_Koharu ()
        {
            GameObject koharu = GameObject.Find ("hiyori");
            if (koharu != null) {
